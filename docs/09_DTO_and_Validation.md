...
2. Устанавливаем пакеты `symfony/serializer-pack`, `symfony/validator` и `symfony/expression-language`
3. Добавляем класс `App\Controller\Web\CreateUser\v1\Input\CreateUserDTO`
    ```php
    <?php
